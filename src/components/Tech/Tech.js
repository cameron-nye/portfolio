...
export default class Tech extends Component {
  render() {
    return (
      <div className="page2">
        <div className="page2Title">Technologies
        {/* <FontAwesomeIcon icon='angle-down' id='arrowDownTech'/> */}
        ...
        <div className="page2cont">
          <section>
            ...
            <div className="techstack">
              ...
              <div className="square">
                <img className="techimground" src={node} alt="" />
                <h5>NodeJS</h5>
              </div>
              <div className="square">
                <img className="techimground" src={express} alt="" />
                <h5>Express</h5>
              </div>
              <div className="square">
                <img className="techimg" src={sql} alt="" />
                <h5>PostgreSQL</h5>
              </div>
              <div className="square">
              ...
              <div className="square">
                <img className="techimg" src={api} alt="" />
                <h5>RESTful API</h5>
              </div>
              <div className="square">
                <img className="techimg" src={auth} alt="" />
                <h5>Auth0</h5>
              </div>
              <div className="square">
                <img className="techimg" src={git} alt="" />
                <h5>Git</h5>
              </div>
              <div className="square">
                <img className="techimg" src={jest} alt="" />
                <h5>Jest</h5>
              </div>
            </div>
          </section>
